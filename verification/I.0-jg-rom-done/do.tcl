...
assume -name additional_mapping_control_assume18 {m1.cxrom_data_out == __ILA_I_oc8051_ROM_rdata_0}
assume -name additional_mapping_control_assume19 {m1.op1 == __ILA_I_oc8051_ROM_rdata_0}
assume -name additional_mapping_control_assume20 {m1.op2 == __ILA_I_oc8051_ROM_rdata_1}
assume -name additional_mapping_control_assume21 {m1.op3 == __ILA_I_oc8051_ROM_rdata_2}
assume -name additional_mapping_control_assume22 {(m1.cxrom_addr != __ILA_SO_PC) || ((m1.cxrom_data_out[7:0] == __ILA_I_oc8051_ROM_rdata_0) && (m1.cxrom_data_out[15:8] == __ILA_I_oc8051_ROM_rdata_1) && (m1.cxrom_data_out[23:16] == __ILA_I_oc8051_ROM_rdata_2))}
assume -name additional_mapping_control_assume23 {(m1.cxrom_addr != (__ILA_SO_PC+1)) || ((m1.cxrom_data_out[7:0] == __ILA_I_oc8051_ROM_rdata_1) && (m1.cxrom_data_out[15:8] == __ILA_I_oc8051_ROM_rdata_2))}
assume -name additional_mapping_control_assume24 {(m1.cxrom_addr != (__ILA_SO_PC+2)) || ((m1.cxrom_data_out[7:0] == __ILA_I_oc8051_ROM_rdata_2))}
assume -name additional_mapping_control_assume25 {(m1.cxrom_addr != (__ILA_SO_PC-1)) || ((m1.cxrom_data_out[15:8] == __ILA_I_oc8051_ROM_rdata_0) && (m1.cxrom_data_out[23:16] == __ILA_I_oc8051_ROM_rdata_1) && (m1.cxrom_data_out[31:24] == __ILA_I_oc8051_ROM_rdata_2))}
assume -name additional_mapping_control_assume26 {__ILA_SO_PSW[6:0] == m1.oc8051_sfr1.oc8051_psw1.data}
assume -name issue_decode27 {(~ __START__) || (__ILA_oc8051_decode_of_I__DOT__0__)}
assume -name issue_valid28 {(~ __START__) || (__ILA_oc8051_valid__)}
